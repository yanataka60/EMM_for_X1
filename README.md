...
### 2026.1.24 すーぱーたーぼさんのご指摘によりHM628512のWE信号の電圧を計測したところ、書き込み時瞬間的に5.9Vほどの電圧が掛かることが判りました。今のところHM628512にダメージは発生していませんが、気になる方はD3 1S4を取り付けずにジャンパでショートしてください。この場合、バックアップ期間は3週間ほどになります。
