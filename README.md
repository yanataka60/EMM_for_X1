...
　2)CR-2032のバックアップにより電源を切ってもメモリ内容が保持されます。(バックアップ期間は、今のところの計算では~~1か月程度~~2～3か月程度、伸ばすことが出来るか実験中)

### 2026.1.23 Rev1.5基板にてバッテリーバックアップが正常に動作するようになりました。

~~2026.1.24 すーぱーたーぼさんのご指摘によりHM628512のWE信号の電圧を計測したところ、書き込み時瞬間的に5.9Vほどの電圧が掛かることが判りました。今のところHM628512にダメージは発生していませんが、気になる方はD3 1S4を取り付けずにジャンパでショートしてください。この場合、バッテリーバックアップは正常に機能しなくなります。~~

### 2026.1.25 D1,D2を1N4148に変更することでHM628512の問題は解決、バックアップ期間も2～3か月程度となりました。なお、長期的にはU2 74LS04の劣化があるかもしれません。万が一不具合が発生した場合はU2 74LS04を交換してみてください。
